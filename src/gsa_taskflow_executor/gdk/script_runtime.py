...
from .session import GdkSessionLease, GdkSessionManager
    ...
    *,
    ...
    try:
        lease = manager.acquire(
            blocking=True,
            initialize=False,
            purpose=f"script:{definition.script_id}",
        )
    ...
    with lease:
        ...
        return with_session_payload(result, lease=lease)
